...
<section class="bg-bg text-fg">
  <!-- New Title/Intro section -->
	<div class="mx-auto max-w-7xl px-4 pt-36 pb-20">
		<div class="mx-auto max-w-3xl pb-10 md:pb-20 text-center">
		 ...
		 <!-- New Form Section -->
		<div class="form-card">
			<p class="pt-2 text-base leading-7 text-fg/75 sm:text-lg">
					Tell us about your event and we'll get back to you with availability, details, and a quote:
			</p>
			<div class="overflow-hidden" style="height: calc(100% + 60px); margin-top: -40px;">
				<iframe 
					title="Inquiry Form"
